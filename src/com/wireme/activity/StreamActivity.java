...
public class StreamActivity extends Activity {
	...
	private static final Logger log = Logger.getLogger(StreamActivity.class
			.getName());
	...
	OnItemClickListener deviceItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View v, int position,
			...
			upnpService.getControlPoint().execute(
					...
					new ContentBrowseActionCallback(StreamActivity.this, service,
	...
	OnItemClickListener contentItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View v, int position,
			...
			if (content.isContainer()) {
				upnpService.getControlPoint().execute(
						new ContentBrowseActionCallback(StreamActivity.this,
								content.getService(), content.getContainer(),
								contentListAdapter));
			} else {
				Intent intent = new Intent();
				intent.setClass(StreamActivity.this, GPlayer.class);
